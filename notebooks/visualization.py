...
def run_visualization():
    ...
    # cross_org_tables = {'miRNA_Net': r"base_19_11_2021 19_01_25.csv", 'xgboost': r"xgboost_19_11_2021 19_07_12.csv"}
    ...
    create_intra_transfer_graphs(model_list,True) # should be the same for aa1
